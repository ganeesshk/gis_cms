<?php
// admin/galleries/photo/create.php
...
<head>
    ...
    <title>Create Photo Gallery - CMS Admin</title>
    ...
    <div class="main-content">
        ...
        <div class="form-container">
            ...
            <div class="info-box">
                ...
                <strong>Getting Started:</strong> Create your gallery first, then you can add photos from the media library.
            </div>
            ...
            <form method="POST" action="/admin/galleries/photo/store.php">
                ...
                <div class="form-group">
                    ...
                    <input type="text" 
                           ...
                           placeholder="e.g., Company Events, Product Shots, Team Photos"
                           required>
                    <div class="form-text">Choose a descriptive name for your gallery</div>
                </div>
                ...
                <div class="action-buttons">
                    ...
                    <a href="/admin/galleries/photo/" class="btn-secondary">
