<?php
// admin/galleries/video/index.php
...
<head>
    ...
    <title>Video Galleries - CMS Admin</title>
    ...
    <div class="main-content">
        ...
        <div class="header">
            <div class="page-title">
                ...
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Video Galleries</span>
                </div>
            </div>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3><?php echo $stats['avg_videos']; ?></h3>
                    <p>Avg per Gallery</p>
                </div>
            </div>
        </div>
        ...
        <div class="toolbar">
            ...
            <a href="/admin/galleries/video/create.php" class="btn-primary">
        ...
        <?php if (empty($galleries)): ?>
            <div class="empty-state">
                ...
                <p>Create your first video gallery to start organizing your YouTube videos.</p>
                <a href="/admin/galleries/video/create.php" class="btn-primary">
                    <i class="fas fa-plus-circle"></i>
                    ...
                    <div class="gallery-card">
                        ...
                        <div class="gallery-info">
                            ...
                            <div class="gallery-meta">
                                <span><i class="fas fa-film"></i> <?php echo $gallery->video_count; ?> videos</span>
                            ...
                            <div class="gallery-actions">
                                <a href="/admin/galleries/video/edit.php?id=<?php echo $gallery->id; ?>" class="btn-edit">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                
                                <?php if ($gallery->is_public): ?>
                                    <a href="/galleries/video/<?php echo $gallery->slug; ?>" class="btn-view" target="_blank">
    ...
    <script>
        ...
        function deleteGallery(id, name) {
            Swal.fire({
                ...
                html: `Are you sure you want to delete "<strong>${name}</strong>"?<br>All videos in this gallery will also be removed.`,
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    window.location.href = '/admin/galleries/video/delete.php?id=' + id + '&token=' + document.getElementById('csrfToken').value;
                }
            });
        }
